...
Atascadero, CA 93422 & http://marczych.com \\
\end{tabular*}
\\
...
\item
   ...
   \begin{itemize}
      \resitem{Performed day-to-day operations to support new application features and improve the website's infrastructure}
   ...
   \begin{itemize}
      ...
      \resitem{Contributed blog posts to itbrokeand.ifixit.com}
   \end{itemize}
...
\begin{description}
\item[Languages:]
PHP, Java, Javascript, Bash, Ruby, C/C{}\verb!++!
...
\item[Unix:]
Very comfortable on the Unix command line including Vim, Git, Bash, Zsh, tmux, and SSH
...
\begin{description}
\item[2014-Present] Primary developer on the PHP caching library Matryoshka.
\end{description}
